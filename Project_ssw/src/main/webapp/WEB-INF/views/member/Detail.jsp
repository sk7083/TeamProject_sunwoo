...
<div class="container">
		  <div class="row">
		    ...
		    <div class="col-75">
		      <input type="text" name="me_pw" value="${Detail.me_pw}" class="wer" disabled> 
		    </div>
		  </div>
		    ...
		    <div class="col-75">
		      <input type="text" name="me_name" value="${Detail.me_name}" class="wer" disabled> 
		    </div>
		  </div>
		    ...
		    <div class="col-75">
		      <input type="text" name="me_email" value="${Detail.me_email}" class="wer" disabled> 
		    </div>
		  </div>
		    ...
		    <div class="col-75">
		      <input type="text" name="me_auth" value="${Detail.me_auth}" class="wer" disabled> 
		    </div>
		  </div>
		    ...
		    <div class="col-75">
		      <input type="text" name="me_phone" value="${Detail.me_phone}" class="wer" disabled> 
		    </div>
		  </div>
		    ...
		    <div class="col-75">
		      <input type="text" name="me_birth" value="${Detail.me_birth}" class="wer" disabled> 
		    </div>
		  </div>
