	...
	<div style="margin-left: 20%; margin-right: 20%">
		<p style="font-size: 22px; margin-left: 150px; font-weight: bold; position: relative; margin-bottom: 40px">내 정보</p>
		 <form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px;">
			  ...
			  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_id}" disabled style="background: white;">
		  </form>
		  
  		 <form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px">
			  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">이름</label>
			  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_name}" disabled style="background: white;">
		  </form>
		  
  		 <form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px">
			  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">PW</label>
			  <input type="password" class="form-control mb-2 mr-sm-2" value="${Detail.me_pw}" disabled style="background: white;">
		  </form>
		  
  		 <form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px">
			  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">이메일</label>
			  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_email}" disabled style="background: white;">
		  </form>
		  
  		 <form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px">
			  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">생년월일</label>
			  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_birth}" disabled style="background: white;">
		  </form>
		  
		<form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px">
			  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">전화번호</label>
			  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_phone}" disabled style="background: white;">
		</form>
		  
		<form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px">
			  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">우편번호</label>
			  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_address1}" disabled style="background: white;">
		</form>
		  
		<form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px"">
			  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">주소</label>
			  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_address2}" disabled style="background: white;">
		</form>
		
		<form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px"">
			  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">상세주소</label>
			  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_address3}" disabled style="background: white;">
		</form>
		
		<c:if test="${Detail.me_auth == 2}">
			<form class="form-inline" action="/action_page.php" style="border-top: 1px solid #cfcfcf; padding-top: 5px; margin-bottom: 0px; margin-left: 200px"">
				  <label for="email" class="mr-sm-2" style="width: 150px; display: block;">권한</label>
				  <input type="text" class="form-control mb-2 mr-sm-2" value="${Detail.me_auth}" disabled style="background: white;">
			</form>
		</c:if>
		<a href="<c:url value="/Update?me_id=${Detail.me_id}"></c:url>" class="btn-updateLink" style="text-decoration:none; margin-top : 50px; margin-left: 190px; margin-bottom: 50px">수정</a>
		<button class="btn btn-light" type="reset" style="margin-top : 50px; margin-left: 20px; margin-bottom: 50px">취소</button>
	</div>
	<!-- ======================================= 끝 지점 [End] ======================================= -->
</main>
