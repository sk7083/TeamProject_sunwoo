...
<div style=" margin-left: 20%; margin-right: 20%; margin-top: 100px;"> 
	<a href='<c:url value="/boardList1#tel123"></c:url>' id="boardList1-Btn"
			            style="background: #ededed; padding: 5px; border-radius: 5px; color: black; padding-left: 10px; padding-right: 10px; text-decoration: none; float: right; margin-top: -50px">목록</a>
	<div style="border: 1px solid #ced4da; border-radius: 10px; padding: 25px">
		...
		<!-- ================================ 아래부터 게시판 내용 ================================ -->
		<div style="margin-top: 30px; margin-bottom: 100px; font-size: 19px">${Detail.bo_content}</div>
		...
		<div style="border: 1px solid #ced4da; border-radius: 5px; padding: 20px; font-size: 14px; font-weight: bold; border-radius: 10px;">${Detail.bo_writer}
			<div style="display: flex;">
				<textarea id="textarea" placeholder="댓글을 남겨보세요." style="font-size: 13px; border: none; margin-top: 10px; width: 100%; overflow: hidden; margin-bottom: 10px; overflow-wrap: break-word; resize: none; "></textarea>
