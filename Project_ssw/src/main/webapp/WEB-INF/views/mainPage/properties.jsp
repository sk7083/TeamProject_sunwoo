    ...
    <div class="container">
      ...
      <div class="row pb-4">
        ...
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="resources/seapalace-master/img/home/explore4.png" alt="">
            </div>
            <div class="card-body">
        ...
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="resources/seapalace-master/img/home/explore5.png" alt="">
            </div>
            <div class="card-body">
        ...
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="resources/seapalace-master/img/home/explore6.png" alt="">
            </div>
            <div class="card-body">
              <h3 class="card-explore__price">$150.00 <sub>/ Per Night</sub></h3>
              <h4 class="card-explore__title"><a href="#">Family Room</a></h4>
