...
public class ProductVO {
	...
	//입실
	private Date pr_in_time;
	//퇴실
	private Date pr_out_time;
	...
	public Date getPr_in_time() {
		return pr_in_time;
	}
	public void setPr_in_time(Date pr_in_time) {
		this.pr_in_time = pr_in_time;
	}
	public Date getPr_out_time() {
		return pr_out_time;
	}
	public void setPr_out_time(Date pr_out_time) {
		this.pr_out_time = pr_out_time;
	}
	
	@Override
	public String toString() {
		return "ProductVO [pr_pid=" + pr_pid + ", pr_ca_pid=" + pr_ca_pid + ", pr_name=" + pr_name + ", pr_address="
				+ pr_address + ", pr_det_address=" + pr_det_address + ", fi_pid=" + fi_pid + ", re_pid=" + re_pid
				+ ", pr_in_time=" + pr_in_time + ", pr_out_time=" + pr_out_time + "]";
	}
}
